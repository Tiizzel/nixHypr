...
hl.bind(mainMod .. " + SPACE",          hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle applauncher"))
hl.bind(mainMod .. " + SHIFT + Return", hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle applauncher"))
hl.bind(mainMod .. " + SHIFT + W",      hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle wallpaper"))
hl.bind(mainMod .. " + Tab",            hl.dsp.exec_cmd("quickshell ipc -c overview call overview toggle"))
hl.bind(mainMod .. " + X",              hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle session"))
hl.bind(mainMod .. " + K",              hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle keybinds"))
hl.bind(mainMod .. " + C",              hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle network"))
hl.bind(mainMod .. " + V",              hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle clipboard"))
hl.bind(mainMod .. " + M",              hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle calendar"))
hl.bind(mainMod .. " + ALT + P",        hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle settings"))
hl.bind(mainMod .. " + SHIFT + comma",  hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle settings"))
hl.bind(mainMod .. " + CTRL + R",       hl.dsp.exec_cmd(HYPRSCRIPTS .. "/qs_manager.sh toggle focustime"))
