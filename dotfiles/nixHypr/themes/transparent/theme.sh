...
# Set waybar
echo "/nixHypr-transparent-centered;/nixHypr-transparent-centered/default" > $HOME/.config/nixHypr/settings/waybar-theme.sh
$HOME/.config/nixHypr/scripts/launch-bar &

# Set nwg-dock-hyprland
echo "transparent" > $HOME/.config/nixHypr/settings/dock-theme
