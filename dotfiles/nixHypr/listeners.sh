...
declare -A LISTENERS
LISTENERS["gtk-theme-switcher"]="$HOME/.config/nixHypr/listeners/gtk-theme-switcher.sh"
LISTENERS["low-bat-notification"]="$HOME/.config/nixHypr/listeners/low-bat-notification.sh"
# Example for another listener:
# LISTENERS["another-listener"]="$HOME/.config/nixHypr/listeners/another-listener.sh"
