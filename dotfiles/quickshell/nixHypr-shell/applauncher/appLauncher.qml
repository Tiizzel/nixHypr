...
Item {
    ...
    Process {
        id: appFetcher
        running: true
        command: ["bash", "-c", "python3 " + Quickshell.env("HOME") + "/.config/quickshell/nixHypr-shell/applauncher/app_fetcher.py"]
    ...
    function launchApp(execStr) {
        var escapedExec = execStr.replace(/'/g, "\\'");
        Quickshell.execDetached(["hyprctl", "dispatch", "hl.dsp.exec_cmd('" + escapedExec + "')"]);
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Text {
                                ...
                                transform: Translate { x: nameLabel.textShift }
