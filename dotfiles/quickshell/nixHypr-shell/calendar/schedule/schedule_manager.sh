...
UPDATER_SCRIPT="$HOME/.config/quickshell/nixHypr-shell/calendar/schedule/get_schedule.py"
SHELL_NIX="$HOME/.config/quickshell/nixHypr-shell/calendar/schedule/shell.nix"
