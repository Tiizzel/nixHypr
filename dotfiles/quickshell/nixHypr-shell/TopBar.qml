    ...
    delegate: Component {
		...
		running: true
            ...
            Process {
                ...
                running: true
                command: ["bash", "-c", "bash ~/.config/quickshell/nixHypr-shell/music/music_info.sh | tee " + paths.getRunDir("music") + "/music_info.json"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
            ...
            Process {
                ...
                command: ["bash", "-c", "~/.config/quickshell/nixHypr-shell/watchers/kb_fetch.sh"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
            ...
            Process { id: kbWaiter; command: ["bash", "-c", "~/.config/quickshell/nixHypr-shell/watchers/kb_wait.sh"]; onExited: { kbPoller.running = false; kbPoller.running = true; } }

            Process {
                id: audioPoller; running: true
                command: ["bash", "-c", "~/.config/quickshell/nixHypr-shell/watchers/audio_fetch.sh"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
            ...
            Process { id: audioWaiter; command: ["bash", "-c", "~/.config/quickshell/nixHypr-shell/watchers/audio_wait.sh"]; onExited: { audioPoller.running = false; audioPoller.running = true; } }

            Process {
                id: networkPoller; running: true
                command: ["bash", "-c", "~/.config/quickshell/nixHypr-shell/watchers/network_fetch.sh"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
            ...
            Process { id: networkWaiter; command: ["bash", "-c", "~/.config/quickshell/nixHypr-shell/watchers/network_wait.sh"]; onExited: { networkPoller.running = false; networkPoller.running = true; } }

            Process {
                id: btPoller; running: true
                command: ["bash", "-c", "~/.config/quickshell/nixHypr-shell/watchers/bt_fetch.sh"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let txt = this.text.trim();
                        if (txt !== "") {
            ...
            Process { id: btWaiter; command: ["bash", "-c", "~/.config/quickshell/nixHypr-shell/watchers/bt_wait.sh"]; onExited: { btPoller.running = false; btPoller.running = true; } }
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                Row { 
                                    ...
                                    anchors.leftMargin: barWindow.s(12)
                                    spacing: barWindow.s(8)
                                    Text { anchors.verticalCenter: parent.verticalCenter; text: "󰌌"; font.family: "Iosevka Nerd Font"; font.pixelSize: barWindow.s(16); color: parent.parent.isHovered ? mocha.text : mocha.subtext0 }
                            ...
                            Rectangle {
                                ...
                                property bool initAnimTrigger: false
                                Timer { running: rightContent.showLayout && !notifPill.initAnimTrigger; interval: 50; onTriggered: notifPill.initAnimTrigger = true }
                                opacity: initAnimTrigger ? 1 : 0
                            ...
                            Rectangle {
                                ...
                                property bool initAnimTrigger: false
                                Timer { running: rightContent.showLayout && !volPill.initAnimTrigger; interval: 100; onTriggered: volPill.initAnimTrigger = true }
                                opacity: initAnimTrigger ? 1 : 0
                            ...
                            Rectangle {
                                ...
                                property bool initAnimTrigger: false
                                Timer { running: rightContent.showLayout && !wifiPill.initAnimTrigger; interval: 150; onTriggered: wifiPill.initAnimTrigger = true }
                                opacity: initAnimTrigger ? 1 : 0
                            ...
                            Rectangle {
                                ...
                                property bool initAnimTrigger: false
                                Timer { running: rightContent.showLayout && !btPill.initAnimTrigger; interval: 200; onTriggered: btPill.initAnimTrigger = true }
                                opacity: initAnimTrigger ? 1 : 0
                            ...
                            Rectangle {
                                ...
                                property bool initAnimTrigger: false
                                Timer { running: rightContent.showLayout && !logoutPill.initAnimTrigger; interval: 250; onTriggered: logoutPill.initAnimTrigger = true }
                                opacity: initAnimTrigger ? 1 : 0
