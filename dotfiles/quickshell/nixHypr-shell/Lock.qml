    ...
    WlSessionLock {
        ...
        WlSessionLockSurface {
            ...
            Item {
                ...
                property string staticWallpaperPath: "file://" + paths.getCacheDir("wallpaper") + "/current_wallpaper.png"
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            Item {
                                ...
                                Rectangle {
                                    anchors.verticalCenter: parent.verticalCenter
                                    width: sliderTrackContainer.width; height: 8 * screenRoot.sc; radius: height / 2; color: root.surface2
                                    Rectangle {
                                        width: ((lockSettings.revealDuration - 100) / 2900) * sliderTrackContainer.width
                                ...
                                Rectangle {
                                    ...
                                    anchors.verticalCenter: parent.verticalCenter
                                    x: Math.max(0, Math.min(((lockSettings.revealDuration - 100) / 2900) * sliderTrackContainer.width - (sliderThumb.width / 2), sliderTrackContainer.width - sliderThumb.width))
                                ...
                                MouseArea {
                                    ...
                                    function updateVal(mouseX) {
                                        if (sliderMouse.width <= 0) return;
                                        let pct = Math.max(0, Math.min(1, mouseX / sliderMouse.width));
